...
int main(int argc, char** argv)
{
	...
	im.FillTriangle(POINT(10, 10), POINT(100, 100), POINT(100, 200), RGB_RED);
	im.FillCircle(POINT(200, 200), 100, SetRGB(255, 104, 0));
	im.DrawCircle(POINT(200, 200), 100, RGB_BLACK, 5);
